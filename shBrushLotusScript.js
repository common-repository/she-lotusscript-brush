...
SyntaxHighlighter.brushes.LotusScript = function()
{
 ...
 ' Eqv Erase Erl Err Error Error$ Evaluate Event Execute Exit Exp Explicit FALSE FileAttr FileCopy FileDateTime FileLen Fix' + 
 ...
 ' Random Randomize Read ReDim Remove Reset Replace ReplaceSubstring Resume Return Right Right$ RightB RightB$ RightBP RightBP$ RmDir Rnd Round' + 
...
SyntaxHighlighter.brushes.LotusScript.aliases  = ['ls', 'lotusscript'];
